          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Select value={shippingSubdivision} fullWidth onChange={(e) => setShippingSubdivision(e.target.value)}>
                {subdivisions.map((subdivision) => (<MenuItem key={subdivision.id} value={subdivision.label}>{subdivision.label}</MenuItem>
                ))}
            ...
            <Grid item xs={12} sm={6}>
              ...
              {options.map((option) => (<MenuItem key={option.id} value={option.label}>{option.label}</MenuItem>
                ))}
              </Select>
            </Grid>
          </Grid>
